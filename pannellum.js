...
window.libpannellum = (function (E, g, p) {
  function Ba(K) {
    ...
    function Ja(a, d, g, p, k) {
      var h;
      var e = d.vertices;
      h = la(a, e.slice(0, 3));
      var u = la(a, e.slice(3, 6)),
        x = la(a, e.slice(6, 9)),
        e = la(a, e.slice(9, 12)),
        t = h[0] + u[0] + x[0] + e[0];
      -4 == t || 4 == t
      ...
      if (h) {
        ...
        if (d.level < c.level) {
          ...
          if (l < m.tileResolution)
            if (d.x == u && d.y != u) {
              if (((A = z = 0.5), "d" == d.side || "u" == d.side)) B = D = 0.5;
            } else
              d.x != u &&
                d.y == u &&
                ((F = s = 0.5), "l" == d.side || "r" == d.side) &&
                (B = D = 0.5);
          x <= m.tileResolution &&
            (d.x == u &&
              ((s = 0), (F = 1), "l" == d.side || "r" == d.side) &&
              ((D = 0), (B = 1)),
            d.y == u &&
              ((z = 0), (A = 1), "d" == d.side || "u" == d.side) &&
              ((D = 0), (B = 1)));
          l = [
            h[0],
            h[1],
          ...
          l = new ka(l, d.side, d.level + 1, 2 * d.x, 2 * d.y, m.fullpath);
          e.push(l);
          (d.x == u && x <= m.tileResolution) ||
            ((l = [
              h[0] * s + h[3] * F,
              h[1] * t + h[4] * y,
              h[2] * D + h[5] * B,
          ...
          (d.y == u && x <= m.tileResolution) ||
            ...
            e.push(l));
          for (d = 0; d < e.length; d++) Ja(a, e[d], g, p, k);
        }
      }
    }
    function ta() {
    ...
    K.appendChild(A);
    var c, a, U, V, $, R, wa, ga, m, z, G, ca, Fa, Y, na, va;
    this.init = function (L, d, Ca, I, k, h, e, u) {
      function x(a) {
        if (E) {
          var d = a * a * 4,
            h = new Uint8ClampedArray(d),
      ...
      if (
        ...
        I = m.basePath ? m.basePath + m.fallbackPath : m.fallbackPath;
        var Q = "frblud".split(""),
          S = 0;
        k = function () {
          var a = g.createElement("canvas");
          ...
          var h = d.getImageData(0, 0, a.width, a.height),
            c = h.data,
            b,
            e;
          ...
          for (e = 0; 4 > e; e++)
            ((c[e] = c[4 * (a.width + 1) + e]),
              (c[4 * (a.width - 1) + e] = c[4 * (2 * a.width - 2) + e]),
              (c[a.width * (a.height - 1) * 4 + e] =
                c[4 * (a.width * (a.height - 2) + 1) + e]),
              (c[4 * (a.width * a.height - 1) + e] =
                c[4 * (a.width * (a.height - 1) - 2) + e]));
        ...
        var D = function () {
            0 < this.width
              ...
              : (E = !0);
            S++;
            6 == S && (($ = this.width), K.appendChild(R), e());
          },
          E = !1;
        for (t = 0; 6 > t; t++)
          ((h = new Image()),
        ...
        a.useProgram(c);
        c.drawInProgress = !1;
        d = u.backgroundColor ? u.backgroundColor : [0, 0, 0];
            ...
            "cubemap" == z
              ...
              : m.width <= L
                ...
                : (a.uniform1i(a.getUniformLocation(c, "u_splitImage"), 1),
                  (I = g.createElement("canvas")),
                  (I.width = m.width / 2),
                  (I.height = m.height),
                  (I = I.getContext("2d")),
                  I.drawImage(m, 0, 0),
                  (k = I.getImageData(0, 0, m.width / 2, m.height)),
                  a.texImage2D(y, 0, a.RGB, a.RGB, a.UNSIGNED_BYTE, k),
                  (c.texture2 = a.createTexture()),
                  a.activeTexture(a.TEXTURE1),
                  a.bindTexture(y, c.texture2),
                  a.uniform1i(a.getUniformLocation(c, "u_image1"), 1),
                  I.drawImage(m, -m.width / 2, 0),
                  (k = I.getImageData(0, 0, m.width / 2, m.height)),
                  a.texImage2D(y, 0, a.RGB, a.RGB, a.UNSIGNED_BYTE, k),
        ...
        if (0 !== I)
          throw (
            console.log("Error: Something went wrong with WebGL!", I),
            { type: "webgl error" }
          );
        e();
      }
    ...
    this.render = function (g, d, l, s) {
      ...
      if (ga !== p) {
        ...
        var e = ga[1],
          ...
          x = d,
          t =
            Math.cos(e) * Math.sin(g) * Math.sin(k) +
            Math.cos(g) *
              (Math.cos(k) * Math.cos(d) +
                Math.sin(e) * Math.sin(k) * Math.sin(d)),
          E =
            -Math.sin(g) * Math.sin(e) +
            Math.cos(g) * Math.cos(e) * Math.sin(d);
        g =
          Math.cos(e) * Math.cos(k) * Math.sin(g) +
          Math.cos(g) *
            (-Math.cos(d) * Math.sin(k) +
              Math.cos(k) * Math.sin(e) * Math.sin(d));
        g = Math.asin(Math.max(Math.min(g, 1), -1));
        d = Math.atan2(E, t);
        k = [
          Math.cos(u) *
            (Math.sin(e) * Math.sin(k) * Math.cos(x) -
              Math.cos(k) * Math.sin(x)),
          Math.cos(u) * Math.cos(e) * Math.cos(x),
          Math.cos(u) *
            (Math.cos(k) * Math.sin(e) * Math.cos(x) +
              Math.sin(x) * Math.sin(k)),
        ];
        e = [-Math.cos(g) * Math.sin(d), Math.cos(g) * Math.cos(d)];
        e = Math.acos(
          Math.max(
            Math.min(
              (k[0] * e[0] + k[1] * e[1]) /
      ...
      if (a || ("multires" != z && "cubemap" != z)) {
        if ("multires" != z)
          ...
          e =
            2 *
            Math.atan(
              (Math.tan(l / 2) * a.drawingBufferHeight) / a.drawingBufferWidth,
            );
          e = 1 / Math.tan(e / 2);
          k = [
            e / k,
          ...
          for (
            ...
            a.drawingBufferWidth >
              m.tileResolution * Math.pow(2, e - 1) * Math.tan(l / 2) * 0.707;
          )
            e++;
          c.level = e;
          e = [1, 0, 0, 0, 1, 0, 0, 0, 1];
          ...
          a.uniformMatrix4fv(c.perspUniform, !1, new Float32Array(ma(k)));
          a.uniformMatrix4fv(c.cubeUniform, !1, new Float32Array(ma(e)));
          h = [
            k[0] * e[0],
            k[0] * e[1],
            k[0] * e[2],
          ...
          if (
            ...
            for (
              k = c.nodeCache.splice(200, c.nodeCache.length - 200), e = 0;
              e < k.length;
              e++
            )
          ...
          e = "fbudlr".split("");
          for (k = 0; 6 > k; k++)
            ((u = new ka(wa[k], e[k], 1, 0, 0, m.fullpath)), Ja(h, u, g, d, l));
          ...
          if (0 === S.length)
            for (g = 0; g < c.currentNodes.length; g++)
              if (((d = c.currentNodes[g]), !d.texture && !d.textureLoad)) {
                d.textureLoad = !0;
                setTimeout(Ka, 0, d);
                break;
              }
        ...
        for (
          ...
          if ((h = R.querySelector(".pnlm-" + l[g] + "face")))
            ((h.style.webkitTransform = d + s[l[g]]),
              (h.style.transform = d + s[l[g]]));
    };
      ...
      La = (function () {
        function c() {
          ...
          var d = function () {
            ...
            S.length
              ? ((c = S.shift()), e.loadTexture(c.src, c.texture, c.callback))
              : (l[g++] = e);
          };
        ...
        for (var h = 0; h < g; h++) l[h] = new c();
        return function (c, h, m, p) {
          k = p;
          p = a.createTexture();
          g ? l[--g].loadTexture(h, p, m) : S.push(new d(c, h, p, m));
          return p;
        };
      })();
  }
  ...
  return {
    renderer: function (g, l, p, s) {
      return new Ba(g, l, p, s);
    },
  };
})(window, document);
  ...
  function Ba(s, l) {
    ...
    function pa() {
      ...
      Sa ||
        ...
        s.addEventListener("mozfullscreenchange", e, !1),
        s.addEventListener("webkitfullscreenchange", e, !1),
        s.addEventListener("msfullscreenchange", e, !1),
        s.addEventListener("fullscreenchange", e, !1),
    ...
    function Ba(a) {
      ...
      f.addEventListener("loadend", function () {
        ...
        if (-1 < c && !0 !== b.ignoreGPanoXMP) {
          var e = n.substring(c, n.indexOf("</x:xmpmeta>") + 12),
            d = function (a) {
              var b;
              0 <= e.indexOf(a + '="')
                ? ((b = e.substring(e.indexOf(a + '="') + a.length + 2)),
                  (b = b.substring(0, b.indexOf('"'))))
                : 0 <= e.indexOf(a + ">") &&
                  ((b = e.substring(e.indexOf(a + ">") + a.length + 1)),
                  (b = b.substring(0, b.indexOf("<"))));
              return b !== p ? Number(b) : null;
            },
            n = d("GPano:FullPanoWidthPixels"),
            c = d("GPano:CroppedAreaImageWidthPixels"),
            g = d("GPano:FullPanoHeightPixels"),
            h = d("GPano:CroppedAreaImageHeightPixels"),
            l = d("GPano:CroppedAreaTopPixels"),
            k = d("GPano:PoseHeadingDegrees"),
            m = d("GPano:PosePitchDegrees"),
            d = d("GPano:PoseRollDegrees");
          null !== n &&
            null !== c &&
            null !== g &&
            null !== h &&
            ...
            null !== m &&
              ...
              0 > aa.indexOf("horizonRoll") && (b.horizonRoll = d)));
        }
    ...
    function ta(a) {
      ...
      a = (f.x / n) * 2 - 1;
      var c = ((1 - (f.y / c) * 2) * c) / n,
        d = 1 / Math.tan((b.hfov * Math.PI) / 360),
        e = Math.sin((b.pitch * Math.PI) / 180),
        g = Math.cos((b.pitch * Math.PI) / 180),
        f = d * g - c * e,
        n = Math.sqrt(a * a + f * f),
        c = (180 * Math.atan((c * g + d * e) / n)) / Math.PI;
    ...
    function la(a) {
      if (b.draggable && (a.preventDefault(), H && (N = Date.now()), ha && H)) {
        var f = Q(a.targetTouches[0]),
          n = f.x,
          c = f.y;
      ...
      if (H) {
        ...
        d =
          "undefined" !== typeof performance && performance.now()
            ...
            : Date.now();
        ba === p && (ba = d);
        var e = ((d - ba) * b.hfov) / 1700,
          e = Math.min(e, 1);
        r[0] &&
          !0 === b.keyboardZoom &&
          (x(b.hfov + (0.8 * w.hfov + 0.5) * e), (a = !0));
        r[1] &&
          !0 === b.keyboardZoom &&
          (x(b.hfov + (0.8 * w.hfov - 0.2) * e), (a = !0));
        if (r[2] || r[6]) ((b.pitch += (0.8 * w.pitch + 0.2) * e), (a = !0));
        if (r[3] || r[7]) ((b.pitch += (0.8 * w.pitch - 0.2) * e), (a = !0));
        if (r[4] || r[8]) ((b.yaw += (0.8 * w.yaw - 0.2) * e), (a = !0));
        if (r[5] || r[9]) ((b.yaw += (0.8 * w.yaw + 0.2) * e), (a = !0));
        a && (N = Date.now());
        if (b.autoRotate) {
          if (0.001 < d - ba) {
            var a = (d - ba) / 1e3,
              g = ((w.yaw / a) * e - 0.2 * b.autoRotate) * a,
              g =
                (0 < -b.autoRotate ? 1 : -1) *
        ...
        0 < e &&
          !b.autoRotate &&
          ((a = 1 - b.friction),
          r[4] || r[5] || r[8] || r[9] || O.yaw || (b.yaw += w.yaw * e * a),
          r[2] ||
            r[3] ||
            r[6] ||
            r[7] ||
            O.pitch ||
            (b.pitch += w.pitch * e * a),
          r[0] || r[1] || O.hfov || x(b.hfov + w.hfov * e * a));
        ba = d;
        0 < e &&
          ((w.yaw = 0.8 * w.yaw + ((b.yaw - n) / e) * 0.2),
          (w.pitch = 0.8 * w.pitch + ((b.pitch - f) / e) * 0.2),
          (w.hfov = 0.8 * w.hfov + ((b.hfov - c) / e) * 0.2),
      ...
      if (!Za)
        if ((Fa(), Qa && clearTimeout(Qa), ha || !0 === X))
          ...
          0 < a
            ...
            : 0 <= b.autoRotateInactivityDelay &&
              Z &&
              ((b.autoRotate = Z), da.lookAt(Ga, p, ra, 3e3), G());
        }
    }
    function Fa() {
      var a;
      if (H) {
        ...
        if (b.avoidShowingBackground) {
          ...
          b.vaov > b.haov
            ...
            : (n =
                ...
                (1 -
                  Math.min(
                    Math.cos(((b.pitch - e) / 180) * Math.PI),
                    Math.cos(((b.pitch + e) / 180) * Math.PI),
                  )));
        }
        var c = b.maxYaw - b.minYaw,
          ...
          d = 180;
        360 > c &&
          ((e = b.minYaw + b.hfov / 2 + n),
          (d = b.maxYaw - b.hfov / 2 - n),
          c < b.hfov && (e = d = (e + d) / 2),
          (b.yaw = Math.max(e, Math.min(d, b.yaw))));
        !1 === b.autoRotate &&
          (360 < b.yaw ? (b.yaw -= 360) : -360 > b.yaw && (b.yaw += 360));
    ...
    function La(a) {
      ...
      if (a.video) {
        ...
        var d = a.video;
        b.basePath && !qa(d) && (d = b.basePath + d);
        e.src = F(d);
        e.controls = !0;
          ...
          for (d in a.attributes)
            ((d = String(d)
              ...
              l.escapeHTML && (d.startsWith("on") || d.includes("href"))
                ...
                : e.setAttribute(d, a.attributes[d]));
    ...
    function Ca(a) {
      var f = Math.sin((a.pitch * Math.PI) / 180),
        ...
        e = Math.sin((b.pitch * Math.PI) / 180),
        d = Math.cos((b.pitch * Math.PI) / 180),
    ...
    function I(a) {
      ...
      for (f in l.default)
        if (l.default.hasOwnProperty(f))
          if ("strings" == f)
            for (c in l.default.strings)
              l.default.strings.hasOwnProperty(c) &&
                (b.strings[c] = D(l.default.strings[c]));
          else ((b[f] = l.default[f]), 0 <= e.indexOf(f) && aa.push(f));
      if (null !== a && "" !== a && l.scenes && l.scenes[a]) {
        ...
        for (f in d)
          if (d.hasOwnProperty(f))
            if ("strings" == f)
              for (c in d.strings)
                d.strings.hasOwnProperty(c) && (b.strings[c] = D(d.strings[c]));
            else ((b[f] = d[f]), 0 <= e.indexOf(f) && aa.push(f));
        b.scene = a;
      }
      for (f in l)
        if (l.hasOwnProperty(f))
          if ("strings" == f)
            for (c in l.strings)
              l.strings.hasOwnProperty(c) && (b.strings[c] = D(l.strings[c]));
          else ((b[f] = l[f]), 0 <= e.indexOf(f) && aa.push(f));
    }
    function k(a) {
      if ((a = a ? a : !1) && "preview" in b) {
        ...
        sa.style.backgroundImage =
          "url('" + F(c).replace(/"/g, "%22").replace(/'/g, "%27") + "')";
        M.appendChild(sa);
      }
      var c = b.title,
        e = b.author;
          ...
          switch (d) {
            ...
            case "showZoomCtrl":
              v.zoom.style.display =
                b[d] && !1 != b.showControls ? "block" : "none";
              break;
            case "showFullscreenCtrl":
              ...
              break;
            case "hotSpotDebug":
              Wa.style.display = b[d] ? "block" : "none";
              break;
            case "showControls":
              b[d] ||
    ...
    fa.innerHTML =
      'Created By <a href="https://denkanders.com/" target="_blank">Denk Anders</a>';
    J.appendChild(fa);
    ...
    this.removeHotSpot = function (a, c) {
      if (c === p || b.scene == c) {
        ...
        for (d = 0; d < l.scenes[c].hotSpots.length; d++)
          if (
            l.scenes[c].hotSpots[d].hasOwnProperty("id") &&
            l.scenes[c].hotSpots[d].id === a
          )
    ...
    this.destroy = function () {
      ...
      Sa &&
        ...
        s.removeEventListener("mozfullscreenchange", e, !1),
        s.removeEventListener("webkitfullscreenchange", e, !1),
        s.removeEventListener("msfullscreenchange", e, !1),
        s.removeEventListener("fullscreenchange", e, !1),
